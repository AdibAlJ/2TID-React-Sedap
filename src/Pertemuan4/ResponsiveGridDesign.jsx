...
function ResponsiveText(){
    return (
        <div>
            <strong className="bg-amber-300">ResponsiveText</strong>
...
function ResponsiveWidth(){
    return (
        <div className="mb-4">
            <strong className="bg-amber-300">ResponsiveWidth</strong>
            <p>
...
function ResponsiveLayout(){
    return (
        <div>
            <strong className="bg-amber-300">ResponsiveLayout</strong>
             <p class="mt-4">
            ...
            <p>
                ...
                - <strong>lg:grid-cols-4</strong> → Saat ukuran layar <strong>lg (≥1024px)</strong> atau lebih besar, grid akan memiliki 
                <strong>4 kolom</strong>.<br/>
            </p>
